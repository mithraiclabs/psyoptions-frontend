    ...
    <Box style={{ zIndex: 1 }}>
      <TableContainer>
        <Table stickyHeader aria-label="sticky table">
          <TableHead>
            <TableRow>
              <THeadCell colSpan={9} className={classes.headCell}>
                <Box display="flex" flexDirection="row" alignItems="center">
                  ...
                  <StyledTooltip
                    ...
                    title={
                      <Box px={1}>
                        <Box py={1}>
                          Smart contracts on Solana cannot take assets from a
                          user's wallet on a whim. For example, if you place a
                          limit order on Serum, and that limit order gets filled
                          Serum cannot just reach into your wallet and pull out
                          the required tokens to fill the order. So Serum must
                          create vaults that hold your tokens as soon as you
                          place an order.
                        </Box>
                        <Box py={1}>
                          So no matter what, when you place an order you
                          transfer the amount of assets required for that order
                          to the Serum protocol's vault for your wallet and the
                          serum market. If your order doesn't get filled and you
                          cancel the order than you have to settled the original
                          tokens (SettleFunds) back to your wallet from the
                          vault owned by Serum.
                        </Box>
                        <Box py={1}>
                          If your order gets filled, Serum takes the tokens you
                          put up for the order and swaps it with the other
                          users' tokens they put up on the other end of the
                          trade, and places them in a vault. Now you have to
                          settle the swapped tokens to from the vault account to
                          your wallet.
                        </Box>
                      </Box>
                    }
